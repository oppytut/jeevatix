...
<section class="space-y-8">
  ...
  >
    <div class="space-y-3">
      <p class="text-muted-foreground text-sm font-semibold tracking-[0.32em] uppercase">A11</p>
  ...
  <div class="grid gap-4 md:grid-cols-3">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        <div>
          <p class="text-muted-foreground text-sm">Total pembayaran</p>
    ...
    >
      <div class="flex items-center justify-between gap-4">
        <div>
          <p class="text-muted-foreground text-sm">Success di hasil</p>
          <p class="text-foreground mt-2 text-3xl font-semibold">{successCount}</p>
        </div>
    ...
    >
      <div class="flex items-center justify-between gap-4">
        <div>
          <p class="text-muted-foreground text-sm">Nilai pembayaran di hasil</p>
          <p class="text-foreground mt-2 text-3xl font-semibold">{formatCurrency(totalAmount)}</p>
        </div>
  ...
  >
    ...
    >
      <div class="space-y-2">
        <label class="text-foreground text-sm font-medium" for="payment-search"
    ...
    {#snippet footer()}
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p class="text-muted-foreground text-sm">
          Menampilkan <span class="text-foreground font-semibold">{payments.length}</span> dari {meta.total}
          pembayaran.
        </p>
