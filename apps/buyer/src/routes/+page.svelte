      ...
      <div class="relative space-y-10">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
          <a href={resolve('/events')} class="group">
            <Button
              class="h-14 rounded-full bg-gradient-to-br from-orange-600 to-orange-700 px-8 text-lg font-bold text-white shadow-[var(--shadow-float)] transition-transform duration-200 hover:translate-y-0 hover:scale-105 hover:shadow-[var(--shadow-float)] active:scale-100 active:shadow-[var(--shadow-float)]"
            >
