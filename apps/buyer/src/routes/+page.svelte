...
<section class="relative overflow-hidden py-6 sm:py-8 lg:py-10">
  <div class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-stretch">
    <div
      class="relative overflow-hidden rounded-[2.5rem] border border-border bg-[linear-gradient(135deg,#fff7ed_0%,#fff1d6_30%,#e0f2fe_100%)] p-8 shadow-[0_30px_90px_rgba(15,23,42,0.10)] sm:p-10 lg:p-12"
    >
      <div
      ...
      <div class="relative space-y-8">
        <div
          class="inline-flex w-fit items-center gap-3 rounded-full border border-orange-200/70 bg-card/70 px-4 py-2 text-sm font-semibold tracking-[0.26em] text-orange-700 uppercase backdrop-blur"
        >
        ...
        <div class="space-y-5">
          ...
          <p class="max-w-2xl text-base leading-8 text-foreground sm:text-lg">
        ...
        <div class="flex flex-col gap-3 sm:flex-row">
          ...
          <a
            href="#featured"
            class="inline-flex h-12 items-center justify-center rounded-full border border-border bg-card/70 px-6 text-sm font-semibold text-foreground transition hover:bg-card"
          >
        ...
        <div class="grid gap-4 sm:grid-cols-3">
          <div class="rounded-[1.5rem] border border-border bg-card/75 p-4 backdrop-blur">
            <p class="text-xs font-semibold tracking-[0.24em] text-muted-foreground uppercase">Featured</p>
            <p class="mt-3 text-3xl font-semibold text-foreground">
              {formatCompactNumber(data.featuredEvents.length)}
            </p>
            <p class="mt-2 text-sm text-muted-foreground">Kurasi event dengan momentum paling tinggi.</p>
          </div>
          <div class="rounded-[1.5rem] border border-border bg-card/75 p-4 backdrop-blur">
            <p class="text-xs font-semibold tracking-[0.24em] text-muted-foreground uppercase">Kategori</p>
            <p class="mt-3 text-3xl font-semibold text-foreground">
          ...
          <div class="rounded-[1.5rem] border border-border bg-card/75 p-4 backdrop-blur">
            <p class="text-xs font-semibold tracking-[0.24em] text-muted-foreground uppercase">Upcoming</p>
            <p class="mt-3 text-3xl font-semibold text-foreground">
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
      <div
        class="rounded-[2rem] border border-border bg-card/85 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur sm:p-7"
      >
      ...
      <div
        class="rounded-[2rem] border border-white/80 bg-foreground p-6 text-background shadow-[0_24px_70px_rgba(15,23,42,0.16)] sm:p-7"
      >
        <div class="flex items-center gap-3">
          <div
            class="flex size-12 items-center justify-center rounded-2xl bg-card/10 text-amber-300"
          >
            <MapPin class="size-6" />
          </div>
          <div>
...
<section id="featured" class="py-8 sm:py-10">
  <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
    ...
    <a
      href={resolve('/events')}
      class="text-sm font-semibold text-foreground transition hover:text-foreground"
      >Lihat semua event</a
    >
  </div>
  ...
  <div class="mt-6 grid gap-5 lg:grid-cols-3">
    ...
    {:else}
      <div
        class="rounded-[2rem] border border-dashed border-border bg-card/70 p-10 text-center text-muted-foreground lg:col-span-3"
      >
  ...
  <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
    {#each data.categories as category (category.id)}
      <a
        ...
        class="group rounded-[1.75rem] border border-border bg-card/85 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(15,23,42,0.12)]"
      >
        <div
        ...
        <div class="mt-5 space-y-2">
          <h3 class="text-xl font-semibold tracking-tight text-foreground">{category.name}</h3>
          <p class="text-sm leading-6 text-muted-foreground">
            {category.event_count} event publik siap dijelajahi pada kategori ini.
          </p>
        </div>
        <div
          class="mt-5 flex items-center justify-between text-sm font-semibold text-muted-foreground transition group-hover:text-foreground"
        >
...
<section class="py-8 sm:py-10">
  <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
    <div>
      <p class="text-sm font-semibold tracking-[0.26em] text-muted-foreground uppercase">Upcoming Picks</p>
      <h2 class="mt-2 text-3xl font-semibold tracking-tight text-foreground">
  ...
  <div class="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
    ...
    {:else}
      <div
        class="rounded-[2rem] border border-dashed border-border bg-card/70 p-10 text-center text-muted-foreground md:col-span-2 xl:col-span-4"
      >
