...
<section class="space-y-8 py-6 sm:py-8 lg:py-10">
  ...
  >
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      ...
      <div
        class="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-sm font-medium text-slate-600"
      >
  ...
  <div class="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
    <form
      class="space-y-6 rounded-[2rem] border border-white/80 bg-white/90 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)]"
      method="GET"
    >
      <div
        class="flex items-center gap-2 text-sm font-semibold tracking-[0.24em] text-slate-500 uppercase"
      >
        <Filter class="size-4" />
        Filter Event
      </div>
      ...
      <div class="space-y-3">
        ...
        <select
          id="city"
          name="city"
          class="h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 transition outline-none focus:border-slate-950"
        >
    ...
    <div class="space-y-6">
      <div
        class="flex flex-col gap-3 rounded-[2rem] border border-white/80 bg-white/85 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.06)] sm:flex-row sm:items-center sm:justify-between"
      >
        <div>
      ...
      {:else}
        <div
          class="rounded-[2rem] border border-dashed border-slate-200 bg-white/80 p-10 text-center"
        >
