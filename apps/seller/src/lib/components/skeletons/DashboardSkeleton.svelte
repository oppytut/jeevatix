      ...
      <div class="rounded-[1.7rem] border border-slate-200/80 bg-white p-6 shadow-sm">
        <div class="flex items-start justify-between gap-4">
          <div class="flex-1 space-y-3">
            ...
            <div class="h-9 w-32 animate-pulse rounded-xl bg-slate-200"></div>
        ...
        <tbody class="divide-y divide-slate-100">
          {#each Array.from({ length: 5 }) as _, index (index)}
            <tr>
              ...
              <td class="px-4 py-4">
                <div class="h-4 w-36 animate-pulse rounded-lg bg-slate-200"></div>
              </td>
              <td class="px-4 py-4">
                <div class="h-4 w-24 animate-pulse rounded-lg bg-slate-200"></div>
              </td>
              <td class="px-4 py-4">
                <div class="h-4 w-20 animate-pulse rounded-lg bg-slate-200"></div>
              </td>
              <td class="px-4 py-4">
