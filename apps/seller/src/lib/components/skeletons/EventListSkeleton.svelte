  ...
  >
    <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
      <div class="space-y-3">
        ...
        <div class="h-12 w-96 animate-pulse rounded-2xl bg-slate-200"></div>
        <div class="h-5 w-full max-w-3xl animate-pulse rounded-xl bg-slate-200"></div>
      </div>

      <div class="flex flex-wrap items-center gap-3">
        <div class="h-10 w-28 animate-pulse rounded-lg bg-slate-200"></div>
        <div class="h-10 w-32 animate-pulse rounded-lg bg-slate-200"></div>
      </div>
    </div>
    ...
    <div class="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      {#each Array.from({ length: 4 }) as _, index (index)}
        <div class="rounded-[1.5rem] border border-slate-200 bg-slate-50/70 p-5">
          ...
          <div class="mt-3 h-9 w-20 animate-pulse rounded-xl bg-slate-200"></div>
        </div>
      {/each}
    </div>
  </div>
  ...
  >
    ...
    <div class="mb-5 flex flex-wrap gap-2">
      {#each Array.from({ length: 5 }) as _, index (index)}
        <div class="h-9 w-28 animate-pulse rounded-full bg-slate-200"></div>
      {/each}
    </div>
        ...
        <thead>
          <tr class="text-slate-500">
            ...
            <th class="px-4 py-3 text-right">
              <div class="ml-auto h-4 w-28 animate-pulse rounded bg-slate-200"></div>
            </th>
            <th class="px-4 py-3 text-right">
              <div class="ml-auto h-4 w-16 animate-pulse rounded bg-slate-200"></div>
            </th>
          </tr>
        </thead>
        <tbody class="divide-y divide-slate-100">
          {#each Array.from({ length: 6 }) as _, index (index)}
            <tr>
              <td class="px-4 py-4">
                <div class="space-y-1">
                  <div class="h-4 w-48 animate-pulse rounded-lg bg-slate-200"></div>
              ...
              <td class="px-4 py-4">
                <div class="space-y-1">
                  <div class="h-4 w-56 animate-pulse rounded-lg bg-slate-200"></div>
                  <div class="h-3 w-48 animate-pulse rounded bg-slate-200"></div>
                </div>
              </td>
              <td class="px-4 py-4 text-right">
                <div class="ml-auto space-y-2">
                  <div class="ml-auto h-4 w-16 animate-pulse rounded-lg bg-slate-200"></div>
                  <div class="ml-auto h-2 w-28 animate-pulse rounded-full bg-slate-200"></div>
                </div>
              </td>
              <td class="px-4 py-4 text-right">
                <div class="ml-auto flex justify-end gap-2">
                  <div class="h-8 w-20 animate-pulse rounded-lg bg-slate-200"></div>
                  <div class="h-8 w-16 animate-pulse rounded-lg bg-slate-200"></div>
                  <div class="h-8 w-16 animate-pulse rounded-lg bg-slate-200"></div>
                  <div class="h-8 w-20 animate-pulse rounded-lg bg-slate-200"></div>
                </div>
              </td>
