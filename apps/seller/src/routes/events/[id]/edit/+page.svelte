...
<section class="space-y-8">
  ...
  >
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div class="space-y-3">
        <p class="text-muted-foreground text-sm font-semibold tracking-[0.32em] uppercase">S8</p>
  ...
  {#if isLoading}
    <div class="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
      <div class="border-border bg-muted h-170 animate-pulse rounded-[2rem] border"></div>
      <div class="space-y-6">
        <div class="border-border bg-muted h-56 animate-pulse rounded-[2rem] border"></div>
        <div class="border-border bg-muted h-56 animate-pulse rounded-[2rem] border"></div>
      </div>
    </div>
  {:else}
          ...
          <div class="space-y-6">
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              ...
              <div class="border-border bg-muted/70 rounded-[1.3rem] border p-4">
                ...
                <p class="text-foreground mt-3 text-lg font-semibold">{totalQuota}</p>
              </div>
              <div class="border-border bg-muted/70 rounded-[1.3rem] border p-4">
                <p class="text-muted-foreground text-sm">Status Saat Ini</p>
      ...
      <div class="space-y-6">
        ...
        >
          <div class="text-muted-foreground space-y-3 text-sm">
            <p>
              <span class="text-foreground font-semibold">Draft / Rejected</span> tetap bisa direvisi
              berkali-kali tanpa submit otomatis.
            </p>
            <p>
              <span class="text-foreground font-semibold">Submit review</span> sekarang dilakukan terpisah
              dari halaman detail event.
            </p>
            <p>
              <span class="text-foreground font-semibold">Published / Ongoing</span> tetap butuh hati-hati
              karena perubahan tier destruktif akan ditolak jika sudah ada penjualan.
            </p>
            <p>
              <span class="text-foreground font-semibold">Galeri dan banner</span> bisa diperbarui kapan
